...
class Game{
 ...
 qteSteps(){const s=this.s;if(s.qte.type==='water'&&s.role==='A')return s.flags.support==='door'?[['顶住落下的舱门','A','向左撑门'],['将检修梯推入水中','D','向右放梯'],['拉住搭档的手','W','向上拉起']]:[['压住下滑的配重','D','向右抵住'],['稳住检修梯','A','向左支撑'],['拉住搭档的手','W','向上拉起']];if(s.qte.type==='water')return s.flags.support==='weight'?[['逆转铜轮','A','转轮向左'],['卡住齿口','D','把木楔推入'],['打开泄水闸','W','提起闸杆']]:[['攥紧止水绳','A','稳住绳索'],['顶开落下的舱门','D','撑住门缘'],['抓住上方横梁','W','向上攀住']];return s.role==='A'?[['跃过松动桥板','W','向前跃起'],['避开迎面船篙','A','向左闪身'],['截住深色披风','D','扣住手腕']]:[['将月光引向安全的桥板','A','偏转铜镜'],['抛出绳索封住去路','D','向右投绳'],['压住配重，为搭档落脚','W','稳住踏板']];}
